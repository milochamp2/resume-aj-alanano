  ...
  return (
    <section className="relative flex min-h-[85vh] items-center overflow-hidden">
      ...
      <motion.div
        ...
        animate="visible"
      >
        {/* Bold multi-line heading */}
        <motion.h1
          variants={itemVariants}
          className="text-4xl font-extrabold leading-[1.1] tracking-tight text-white sm:text-5xl md:text-7xl"
        >
          Developer. Creator.
          <br />
          <span className="hero-underline">Problem Solver.</span>
        </motion.h1>

        {/* Animated gradient underline */}
        <motion.div
          variants={itemVariants}
          className="mx-auto mt-3 h-[3px] w-48 rounded-full bg-gradient-to-r from-indigo-light to-aqua sm:w-64"
        />
        ...
        <motion.div variants={itemVariants} className="mt-5">
          <span className="glass inline-flex items-center gap-1.5 rounded-full px-4 py-1.5 text-xs font-medium text-slate-300">
            <span className="inline-block h-1.5 w-1.5 animate-pulse rounded-full bg-aqua" />
            Web Developer &amp; Automation Specialist based in Philippines
          </span>
        </motion.div>
